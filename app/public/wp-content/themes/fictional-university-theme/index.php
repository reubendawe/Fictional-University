    ...
    <div class="hero-slider">
      <div data-glide-el="track" class="glide__track">
        <div class="glide__slides">
          <div class="hero-slider__slide" style="<?php echo get_theme_file_uri('/images/bus.jpg'); ?>">
          ...
          <div class="hero-slider__slide" style="<?php echo get_theme_file_uri('/images/apples.jpg'); ?>">
            <div class="hero-slider__interior container">
              <div class="hero-slider__overlay">
          ...
          <div class="hero-slider__slide" style="<?php echo get_theme_file_uri('/images/bread.jpg'); ?>">
            <div class="hero-slider__interior container">
              <div class="hero-slider__overlay">
